...
void get_voltage ( u16* PTC_voltage_ch7,u16* RTD1_voltage_ch2 ,u16* RTD2_voltage_ch3 )
{
	u32 temp = 0;
	u8  i = 0;
	...
	temp/=5;
	*PTC_voltage_ch7 = temp*5000/4096;
	...
	temp/=5;
	*RTD1_voltage_ch2 = temp*5000/4096;
	delay_us ( 20 );
	temp = 0;
	for ( i=0; i<5; i++ )
	{
	...
	temp/=5;
	*RTD2_voltage_ch3 = temp*5000/4096;
